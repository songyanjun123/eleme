<template>
  <div>
      ...
      <transition name="fold">
        <div class="shopcart-list" v-show="listShow">
          <div class="list-header">
            ...
            <span class="empty" @click="empty($event)">清空</span>
          </div>
    ...
    <transition name="fade">
      <div class="list-mask" v-show="listShow" @click="hideList($event)"></div>
    </transition>
  </div>
</template>
...
//        let rf = el.offsetHeight;
      ...
      pay() {
        if (this.totalPrie < this.minPrice) {
          return;
        } else {
  ...
  .shopCart
    ...
    .ball-container
      .ball
        ...
        bottom 22px
        z-index 200
        transition: all .6s cubic-bezier(0.49, -0.29, 1, 0.54)
        .inner
          width: 16px
          height: 16px
          border-radius: 50%
